...
const letters = ['R', 'U', 'M', 'I'];

function AnimatedTitle() {
  // Animación de wave para cada letra
  const container = {
    hidden: { opacity: 0 },
    visible: {
      opacity: 1,
  ...
  return (
    ...
    >
      <motion.h1
        className="text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-[#0a2342] via-[#2ca6e0] to-[#ffd700] bg-clip-text text-transparent drop-shadow-2xl"
        style={{
      ...
      >
        <span className="text-lg md:text-2xl tracking-widest font-semibold text-[#ffd700] drop-shadow-lg">
...
export default function Home() {
  ...
  return (
    <>
      <title>RUMI | Plataforma de Cursos, Juegos y Comunidad Educativa</title>
      <meta name="description" content="RUMI es una plataforma educativa donde puedes aprender, enseñar, jugar y compartir en comunidad. Descubre cursos, juegos y recursos para potenciar tu aprendizaje." />
      <meta name="keywords" content="RUMI, cursos, educación, juegos, comunidad, aprender, enseñar, plataforma, online" />
      <meta property="og:title" content="RUMI | Plataforma de Cursos, Juegos y Comunidad Educativa" />
      <meta property="og:description" content="Descubre cursos, juegos y recursos en RUMI. Aprende y comparte en una comunidad educativa innovadora." />
      <meta property="og:type" content="website" />
      <meta property="og:image" content="/logo1zeus.png" />
      <meta property="og:url" content="https://rumi.software/" />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="RUMI | Plataforma de Cursos, Juegos y Comunidad Educativa" />
      <meta name="twitter:description" content="Descubre cursos, juegos y recursos en RUMI. Aprende y comparte en una comunidad educativa innovadora." />
      <meta name="twitter:image" content="/logo1zeus.png" />
