...
const GoogleAuthButton = ({ onSuccess, onError, buttonText = "Continuar con Google" }) => {
  ...
  // Si no hay Client ID configurado, mostrar mensaje
  if (!GOOGLE_CLIENT_ID) {
    return (
      <button
        disabled
        className="w-full bg-gray-300 text-gray-500 py-4 px-6 rounded-xl font-semibold text-lg cursor-not-allowed flex items-center justify-center gap-3"
      >
